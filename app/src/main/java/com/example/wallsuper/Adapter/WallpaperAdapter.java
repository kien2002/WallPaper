...
import com.example.wallsuper.Entity.WallpaperModel;
...
public class WallpaperAdapter extends RecyclerView.Adapter<WallpaperViewHolder> {
    ...
    public WallpaperViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(context).inflate(R.layout.view_wallpaper,parent,false);
    ...
    public void onBindViewHolder(@NonNull WallpaperViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.startActivity(new Intent(context,FullScreenWallAdapter.class)
